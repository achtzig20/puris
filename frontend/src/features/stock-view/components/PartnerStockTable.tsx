...
import { Button, Table } from '@catena-x/portal-shared-components';
...
export function PartnerStockTable({ materialNumber, type }: PartnerStockTableProps) {
    ...
    return (
        <div className="relative">
            <Table
                ...
                hideFooter={true}
            ></Table>
            <Button className="absolute top-8 end-8" variant="contained">
                Refresh Stocks
            </Button>
        </div>
    );
