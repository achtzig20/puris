...
if [ -f "$BRUNO_FILE" ]; then
  sed -i 's|^  CUSTOMER_EDC_API_KEY: .*|  CUSTOMER_EDC_API_KEY: {{$processEnv CUSTOMER_EDC_API_KEY}}|' "$BRUNO_FILE"
  sed -i 's|^  CUSTOMER_PURIS_BACKEND_API_KEY: .*|  CUSTOMER_PURIS_BACKEND_API_KEY: {{$processEnv CUSTOMER_PURIS_BACKEND_API_KEY}}|' "$BRUNO_FILE"
  sed -i 's|^  CUSTOMER_MANAGE_CLIENT_SECRET: .*|  CUSTOMER_MANAGE_CLIENT_SECRET: {{$processEnv CUSTOMER_MANAGE_CLIENT_SECRET}}|' "$BRUNO_FILE"
  sed -i 's|^  SUPPLIER_EDC_API_KEY: .*|  SUPPLIER_EDC_API_KEY: {{$processEnv SUPPLIER_EDC_API_KEY}}|' "$BRUNO_FILE"
  sed -i 's|^  SUPPLIER_PURIS_BACKEND_API_KEY: .*|  SUPPLIER_PURIS_BACKEND_API_KEY: {{$processEnv SUPPLIER_PURIS_BACKEND_API_KEY}}|' "$BRUNO_FILE"
  sed -i 's|^  SUPPLIER_MANAGE_CLIENT_SECRET: .*|  SUPPLIER_MANAGE_CLIENT_SECRET: {{$processEnv SUPPLIER_MANAGE_CLIENT_SECRET}}|' "$BRUNO_FILE"
