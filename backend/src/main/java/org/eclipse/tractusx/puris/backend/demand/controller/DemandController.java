...
public class DemandController {
    ...
    public List<DemandDto> getAllDemands(String ownMaterialNumber, Optional<String> site) {
        return ownDemandService.findAllByFilters(Optional.of(ownMaterialNumber), Optional.empty(), site, null)
    ...
    public List<DemandDto> getAllDemandsForPartner(String ownMaterialNumber, Optional<String> bpnl,
        ...
        return reportedDemandService.findAllByFilters(Optional.of(ownMaterialNumber), bpnl, site, null)
                .stream().map(this::convertToDto).collect(Collectors.toList());
    }
