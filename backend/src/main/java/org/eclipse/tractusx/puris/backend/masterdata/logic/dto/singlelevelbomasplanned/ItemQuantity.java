...
/**
 * Generated class for Item Quantity Characteristic. Quantity of which the child 
 * part will be assembled into the parent part. This is a characteristic from 
 * the shared.quantity aspect model.
 */
@Getter
@Setter
@NoArgsConstructor
