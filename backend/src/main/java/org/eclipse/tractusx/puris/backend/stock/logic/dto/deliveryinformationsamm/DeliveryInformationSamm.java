...
@NoArgsConstructor
@ToString
public class DeliveryInformationSamm {
    @NotNull
    @Valid
    ...
    private String materialNumberSupplier;
        ...
        @JsonCreator
    public DeliveryInformationSamm(@JsonProperty(value = "positions") List<Position> positions,
    ...
    public boolean equals(final Object o) {
        ...
        final DeliveryInformationSamm that = (DeliveryInformationSamm) o;
