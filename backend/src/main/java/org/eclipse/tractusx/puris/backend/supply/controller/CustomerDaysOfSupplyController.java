...
import org.eclipse.tractusx.puris.backend.supply.logic.service.CustomerDaysOfSupplyService;
...
@RestController
@RequestMapping("daysOfSupply/customer")
@Slf4j
public class CustomerDaysOfSupplyController {
    @Autowired
    private CustomerDaysOfSupplyService daysOfSupplyService;
