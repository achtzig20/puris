...
public enum AssetType {
    ...
    SINGLE_LEVEL_BOM_AS_PLANNED_SUBMODEL("urn:samm:io.catenax.single_level_bom_as_planned:1.0.0#SingleLevelBomAsPlanned", "$value", "SingleLevelBomAsPlanned", "1.0");
    ...
    public static AssetType fromUrn(String urnSemanticId) {
        return switch (urnSemanticId) {
            ...
            case "urn:samm:io.catenax.demand_and_capacity_notification:3.0.0#DemandAndCapacityNotification" ->
            ...
            case "urn:samm:io.catenax.single_level_bom_as_planned:1.0.0#SingleLevelBomAsPlanned" ->
