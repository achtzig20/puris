...
public class Production {
    ...
    public boolean equals(Object o) {
        ...
        return this.getMaterial().getOwnMaterialNumber().equals(that.getMaterial().getOwnMaterialNumber()) &&
                ...
                (
                    this.getCustomerOrderNumber().equals(that.getCustomerOrderNumber()) && 
                    this.getCustomerOrderPositionNumber().equals(that.getCustomerOrderPositionNumber()) &&
                    this.getSupplierOrderNumber().equals(that.getSupplierOrderNumber())
                );
    }

    @Override
    public int hashCode() {
        return Objects.hash(partner, material, quantity, measurementUnit, productionSiteBpns, estimatedTimeOfCompletion, customerOrderNumber, customerOrderPositionNumber, supplierOrderNumber);
    }
}
