        ...
        http.csrf(AbstractHttpConfigurer::disable)
            .authorizeHttpRequests(
                ...
                (authorizeHttpRequests) -> authorizeHttpRequests
                    .requestMatchers("/stockView/**", "/partners/**", "/materials/**", "/materialpartnerrelations/**", "/item-stock/**", "/production/**", "/delivery/**", "/daysofsupply/**", "/demand/**","/edrendpoint/**", "/edc/**", "/parttypeinformation/**").authenticated()
