        ...
        http.csrf(AbstractHttpConfigurer::disable)
            .authorizeHttpRequests(
                ...
                (authorizeHttpRequests) -> authorizeHttpRequests
                    .requestMatchers("/stockView/**", "/partners/**", "/materials/**", "/materialpartnerrelations/**", "/item-stock/**", "/production/**", "/delivery/**", "/demand/**", "/planned-production/**", "/delivery-information/**", "/edrendpoint/**", "/edc/**", "/parttypeinformation/**")
                    .authenticated()
