...
/**
 * Generated class for Validity Period Entity. If a validity period only has a 
 * start that means that the period is valid from the start date without a (yet)
 * defined enddate and vice versa.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class ValidityPeriodEntity {
    ...
    @JsonCreator
    public ValidityPeriodEntity(@JsonProperty(value = "validFrom") String validFrom,
                                @JsonProperty(value = "validTo") String validTo) {
